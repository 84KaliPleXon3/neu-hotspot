    ...
    , m_diffReportDialog(new DiffReportDialog(this))
{
    ...
    connect(m_startPage, &StartPage::createDiffReportButtonClicked, this, &MainWindow::onDiffReportButtonClicked);
...
void MainWindow::onDiffReportButtonClicked()
{
    m_diffReportDialog->show();
}
